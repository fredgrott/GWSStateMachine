...
A state machine library to use in android java application development. One should be able to use to
reduce the application design complexities and at times make it easier to use other brand new techniques,
